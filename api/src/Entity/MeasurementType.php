...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\MeasurementTypeRepository")
 */
class MeasurementType
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Measurement", mappedBy="measurementType", orphanRemoval=true)
     */
